...
public class Sms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn = findViewById(R.id.gonder);
        EditText textt = findViewById(R.id.tel);
        EditText textm = findViewById(R.id.mesaj);
        ...
        try {
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(ContextCompat.checkSelfPermission(Sms.this, Manifest.permission.SEND_SMS) != PackageManager.PERMISSION_GRANTED){
                        ActivityCompat.requestPermissions(Sms.this, new String[]{Manifest.permission.SEND_SMS},izin_verildi);
                    }else{
                        tel = textt.getText().toString();
                        mesaj = textm.getText().toString();
                        if(mesaj.equals("") || mesaj == null){
                            new GetQuoteTask().execute();
                            Toast.makeText(getApplicationContext(),"Güzel Söz Gönderildi!",Toast.LENGTH_SHORT).show();
                        }else{
                            sendSms(mesaj);
            ...
            Log.e("Sms","Çalışmadı! "+ e.getMessage());
        }
    }
    private void sendSms(String mes){
        try {
            ...
            Log.e("Sms","Gönderemedik!" + e.getMessage());
        }
    }
